...
This app exposes a local HTTP API on port **37434** for integration with [Nova](https://github.com/kochj23) (OpenClaw AI) and Claude Code.
...
```bash
# Check if running
curl -s http://127.0.0.1:37434/api/status | python3 -m json.tool
